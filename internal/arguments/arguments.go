...
var (
	...
	SEAT_COUNT             uint
	PHONE_NUMBER           string
	SEAT_TYPE_ARRAY        = []string{"SNIGDHA", "AC_S", "S_CHAIR"} //, "S_CHAIR", "F_BERTH"}
